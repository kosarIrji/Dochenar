...
function Identify() {
  ...
  return (
    ...
    animate={{ opacity: 1, y: 0 }}
      ...
      className=""
      >
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-center mt-5 mb-3">
        <div
 ...
 p-2 lg:p-4  w-full col-span-1 break-words"
        >
          ...
          <h2 className="font-semibold text-[var(--sidebar] text-center text-lg grid grid-cols ">
           ...
           <span className="mt-1 mx-auto text-[18px] flex gap-2 text-[var(--sidebar)]">
            4.1 <StarRating rating={4.1} color="var(--sidebar)" size={20}/> 
            </span>
          </h2>
        </div>
        <div
