...
function History() {
  const images = [
    { year: "1335", src: "./images/2005.png" },
    { year: "1404", src: "./images/2025.png" },
  ];
        ...
        <div className="lg:col-span-2">
          ...
          <p className="md:leading-loose lg:leading-loose font-modam text-justify text-base ">
            <strong className="text-yellow-800">
              {" "}
              محله دوچنار از نخستین کانون‌های سکونت شهری در بجنورد
            </strong>{" "}
            و یکی از محلات تاریخی شهر است که در دل بافت مرکزی قرار دارد. <strong> نام
            محله از دو چنار کهنسال برگرفته شده که یکی از آن‌ها هنوز پابرجاست و
            به‌عنوان نمادی زنده از هویت تاریخی آن شناخته می‌شود</strong>. در گذشته،
            ساختارهایی مانند مسجد، بازارچه، حمام و گذرهای محلی در این محله شکل
            گرفته بود. اگرچه طی سال‌های اخیر نوسازی‌هایی در آن صورت گرفته، اما
            بخشی از بافت سنتی و اصالت تاریخی محله همچنان حفظ شده و قابل مشاهده
            است.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 w-full gap-5   lg:mt-7 lg:col-span-2 relative">
          ...
          >
            <img
              src={images[0].src}
              loading="lazy"
              alt={`محله دوچنار در سال ${images[0].year}`}
          ...
          >
            <img
              src={images[1].src}
              loading="lazy"
              alt={`محله دوچنار در سال ${images[1].year}`}
              className="rounded-xl shadow-md w-[170px] lg:max-w-[250px] object-cover"
            />
            <p className="text-center mt-3 text-orange-900 text-base leading-relaxed">
              محله دوچنار - سال {images[1].year}
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {selectedImageIndex !== null && (
        <div className="fixed inset-0 z-50 top-[180px] bottom-[40px] flex items-center justify-center ">
          <div className="relative max-w-2xl w-full px-4">
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 left-5 bg-orange-100 hover:bg-orange-200 text-orange-900 p-1 rounded-full shadow-md z-10"
            >
              <XIcon size={24} />
            </button>
            ...
            <div className="bg-white/40 backdrop-blur-sm  rounded-2xl p-4 shadow-lg flex flex-col items-center">
              <img
                ...
                alt={`محله دوچنار - سال ${images[selectedImageIndex].year}`}
                className="w-full h-auto rounded-2xl max-h-[50vh] object-contain"
              />
              <p className="mt-4 text-orange-900 text-lg rounded-2xl font-semibold text-center">
                محله دوچنار - سال {images[selectedImageIndex].year}
              </p>
